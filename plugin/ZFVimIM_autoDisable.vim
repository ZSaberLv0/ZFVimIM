...
augroup ZFVimIM_autoDisable_augroup
    autocmd!
    autocmd User ZFVimIM_event_OnStart for cb in s:callback | let Fn = function(cb[1]) | call Fn() | endfor
    autocmd User ZFVimIM_event_OnStop for cb in s:callback | let Fn = function(cb[0]) | call Fn() | endfor
augroup END
